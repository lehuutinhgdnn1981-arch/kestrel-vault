...
const scanHistory: ScanRecord[] = [
  ...
  { id: '3', date: 'May 18, 2024 11:42 AM', status: 'safe', filesScanned: 338, duration: '41s' },
  { id: '4', date: 'May 17, 2024 08:30 PM', status: 'danger', filesScanned: 338, duration: '42s' },
  { id: '5', date: 'May 16, 2024 02:10 PM', status: 'safe', filesScanned: 335, duration: '40s' },
]
      ...
      <div className="p-8 max-w-4xl mx-auto space-y-6">
        ...
        >
          <div
            ...
            style={{
              backgroundColor: isScanning ? 'rgba(37, 99, 235, 0.1)' : 'rgba(34, 197, 94, 0.1)',
          ...
          <p className="text-xs mb-6" style={{ color: '#94A3B8' }}>
            {isScanning ? `${Math.round(scanProgress)}% complete` : 'Last scan: May 20, 2024 10:30 AM'}
          </p>
          ...
          <button
            ...
            style={{
              backgroundColor: isScanning ? '#E2E8F0' : '#2563EB',
