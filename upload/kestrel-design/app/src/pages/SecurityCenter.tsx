...
const issues = [
  {
    ...
    description: '2 passwords are too weak and easy to guess.',
    count: 2,
  },
  {
    icon: AlertTriangle,
    ...
    description: '3 passwords are reused across multiple sites.',
    count: 3,
  },
  {
    icon: Shield,
    ...
    description: '2 accounts support 2FA but it is not enabled.',
    count: 2,
  },
  {
    icon: ClockIcon,
    ...
    description: "7 passwords haven't been changed in over a year.",
    count: 7,
  },
]
...
export default function SecurityCenter() {
  ...
  const { securityScore } = useVaultStore()
    ...
    <div className="animate-fade-in">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 px-3 h-9 rounded-lg" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E2E8F0', width: '280px' }}>
            <Search size={16} style={{ color: '#64748B' }} />
            <input type="text" placeholder="Search..." className="bg-transparent outline-none text-sm flex-1" style={{ color: '#0F172A' }} />
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="w-full mt-6 space-y-2">
              {[
                ...
                { label: 'Old Items (>1 year)', value: 7, color: '#64748B' },
              ].map((metric) => (
                <div
                  key={metric.label}
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs px-2 py-0.5 rounded-full" style={{ backgroundColor: '#FEF3C7', color: '#92400E' }}>5</span>
              </div>
