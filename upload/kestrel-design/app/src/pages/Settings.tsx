...
const Toggle = ({ defaultOn = false }: { defaultOn?: boolean }) => {
  ...
  return (
    ...
    >
      <div
        className="absolute top-[2px] w-[18px] h-[18px] bg-white rounded-full shadow-sm transition-all duration-150"
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div
            className="absolute top-full left-0 mt-1 w-full rounded-lg py-1 z-20"
            ...
            <section>
              ...
              >
                ...
                <div className="flex items-center justify-between pt-3" style={{ borderTop: '1px solid #E2E8F0' }}>
                  ...
                  <Select options={['English', 'Spanish', 'French', 'German']} defaultValue="English" />
                </div>
              </div>
            </section>
